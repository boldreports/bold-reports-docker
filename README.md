...
|`6.2.32_ubuntu_arm64`| Ubuntu 20.04  (arm64)        | 08/13/2024 |

Note: The tag `6.2.32_ubuntu_arm64` have some limitations where the data visualization will not be work in the exported reports.
