...
4. Create a docker-compose.yml file that starts your `BoldReports` and a separate `PostgreSQL` instance with volume mounts for data persistence:
   ...
   ```sh
     ...
     services:
       id-web:
         ...
         image: us-docker.pkg.dev/boldreports/v6-1-45/bold-identity:6.1.45
         restart: on-failure
         environment:
           # Required
     ...
     id-api:
       ...
       image: us-docker.pkg.dev/boldreports/v6-1-45/bold-identity-api:6.1.45
       restart: on-failure
       volumes: 
         - boldservices_data:/application/app_data
      networks:
   ...
   id-ums:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/bold-ums:6.1.45
      restart: on-failure
      environment:
   ...
   reports-web:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/boldreports-server:6.1.45
      restart: on-failure
      volumes: 
         - boldservices_data:/application/app_data
      networks:
   ...
   reports-api:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/boldreports-server-api:6.1.45
      restart: on-failure
      volumes: 
         - boldservices_data:/application/app_data
      networks:
   ...
   reports-jobs:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/boldreports-server-jobs:6.1.45
      restart: on-failure
      volumes: 
         - boldservices_data:/application/app_data
      networks:
   ...
   reports-viewer:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/boldreports-viewer:6.1.45
      restart: on-failure
      volumes: 
         - boldservices_data:/application/app_data
      networks:
   ...
   reports-designerservice:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/boldreports-designer:6.1.45
      restart: on-failure
      volumes:
         - boldservices_data:/application/app_data
      networks:
   ...
   reports-etl:
      ...
      image: us-docker.pkg.dev/boldreports/v6-1-45/bold-etl:6.1.45
      restart: on-failure
      volumes:
         - boldservices_data:/application/app_data
      networks:
