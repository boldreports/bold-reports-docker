      ...
      ```sh
		...
		services:
		  id-web:
			...
			image: gcr.io/boldreports/bold-identity:5.2.26
			restart: on-failure
			environment: 
		...
		id-api:
		  ...
		  image: gcr.io/boldreports/bold-idp-api:5.2.26
		  restart: on-failure
		  volumes: 
		    - boldservices_data:/application/app_data
		  networks:
		...
		reports-web:
		  ...
		  image: gcr.io/boldreports/boldreports-server:5.2.26
		  restart: on-failure
		  volumes: 
		    - boldservices_data:/application/app_data
		  networks:
		...
		reports-api:
          ...
          image: gcr.io/boldreports/boldreports-server-api:5.2.26
          restart: on-failure
          volumes: 
            - boldservices_data:/application/app_data
          networks:
		...
		reports-jobs:
		  ...
		  image: gcr.io/boldreports/boldreports-server-jobs:5.2.26
		  restart: on-failure
		  volumes: 
			- boldservices_data:/application/app_data
		  networks:
		...
		reports-reportservice:
		  ...
		  image: gcr.io/boldreports/boldreports-designer:5.2.26
		  restart: on-failure
		  volumes: 
			- boldservices_data:/application/app_data
		  networks:
		...
		reports-viewer:
		  ...
		  image: gcr.io/boldreports/boldreports-viewer:5.2.26
		  restart: on-failure
		  volumes: 
		    - boldservices_data:/application/app_data
		  networks:
